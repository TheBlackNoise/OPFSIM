...
function drawPortraitElement(char, positionMode) {
    ...
    if (char.portraitLoaded) {
        if (Array.isArray(char.portraitFrames) && char.portraitFrames.length > 0) {
            ctx.drawImage(char.portraitFrames[portraitFrame], drawX, drawY, 400, 400);
        } else {
            ctx.drawImage(char.portraitFrames, drawX, drawY, 400, 400);
        }
    } else {
